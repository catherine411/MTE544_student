...
class localization(Node):
    ...
    def __init__(self, localizationType=rawSensor):
        ...
        odom_qos=QoSProfile(reliability=ReliabilityPolicy.BEST_EFFORT, durability=DurabilityPolicy.VOLATILE, history=1, depth=10) # check in lab ros2 topic info /odom --verbose
    ...
    def odom_callback(self, pose_msg):
        ...
        odom_orientation = euler_from_quaternion([pose_msg.pose.pose.orientation.x, pose_msg.pose.pose.orientation.y, pose_msg.pose.pose.orientation.z, pose_msg.pose.pose.orientation.w])
        # the above might be uneccessarily overdefining it 
